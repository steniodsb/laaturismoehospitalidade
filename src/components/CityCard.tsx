    ...
    return (
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-5">
          ...
          <h3 className="text-xl font-serif text-background mb-1">{city.name}</h3>
          <p className="text-sm text-background/70 line-clamp-2">{city.shortDescription}</p>
        </div>
      </Link>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        ...
        <h3 className="font-serif text-lg text-foreground mb-1 group-hover:text-primary transition-colors">{city.name}</h3>
        <p className="text-sm text-muted-foreground line-clamp-2">{city.shortDescription}</p>
